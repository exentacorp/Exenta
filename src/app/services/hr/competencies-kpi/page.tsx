...
import { Gauge, ArrowRight, ChevronRight, CheckCircle } from "lucide-react";

const services = [
  { title: "Оценка компетенций и потенциала", description: "Модели компетенций, оценка персонала и выявление потенциала." },
  { title: "Система KPI и целеполагание", description: "Внедрение системы KPI, OKR и согласование целей по уровням." },
  { title: "Мотивация и материальное стимулирование", description: "Системы оплаты труда, премирования и нематериальная мотивация." },
  { title: "HR-аналитика и цифровые инструменты", description: "Дашборды, метрики и цифровые решения для управления персоналом." },
];

export default function HRCompetenciesKPIPage() {
  return (
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Компетенции, KPI и мотивация</span>
          </nav>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#02818a]/10 text-[#02818a] text-sm font-medium mb-6">
                <Gauge className="w-4 h-4" /> Направление
              </div>
              <h1 className="text-4xl lg:text-5xl font-bold text-[#02818a] mb-6">Компетенции, KPI и мотивация</h1>
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative w-72 h-72">
                ...
                <div className="absolute inset-6 bg-[#02818a]/20 rounded-full flex items-center justify-center">
                  <Gauge className="w-24 h-24 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <Link href="/services/hr/organizational-design" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Проектирование структуры и ролей</p>
                  </div>
              ...
              <Link href="/services/hr/culture-leadership" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Культура и управление талантами</p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-[#02818a] group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужна система KPI или оценка компетенций?</h2>
              <p className="text-white/70 max-w-xl">Поможем внедрить KPI и HR-аналитику.</p>
            </div>
