...
import { Factory, ArrowRight, ChevronRight, CheckCircle } from "lucide-react";

const services = [
  { title: "Внедрение бережливого производства", description: "Lean-методологии, устранение потерь и повышение эффективности процессов." },
  { title: "Корпоративное обучение", description: "Программы обучения под цели компании и развитие ключевых компетенций." },
  { title: "Производственное обучение", description: "Обучение на рабочих местах, наставничество и стандартизация операций." },
  { title: "Развитие компетенций", description: "Планирование и реализация программ развития компетенций сотрудников." },
];

export default function LearningCorporateLeanPage() {
  return (
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Бережливое производство и корпоративное обучение</span>
          </nav>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#02818a]/10 text-[#02818a] text-sm font-medium mb-6">
                <Factory className="w-4 h-4" /> Направление
              </div>
              <h1 className="text-4xl lg:text-5xl font-bold text-[#02818a] mb-6">Бережливое производство и корпоративное обучение</h1>
              <p className="text-lg text-gray-600 leading-relaxed">
                Внедрение бережливого производства, корпоративное и производственное обучение, развитие компетенций.
              </p>
            </div>
        ...
        <div className="container-kept">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/services/learning/programs" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-[#02818a] transition-colors">Образовательные программы и стратегия</h3>
                    <p className="text-sm text-gray-500">Готовые программы и учебные модули</p>
                  </div>
              ...
              <Link href="/services/learning/culture-leadership" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Трансформация культуры через обучение</p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-[#02818a] group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Внедряем Lean или корпоративное обучение?</h2>
              <p className="text-white/70 max-w-xl">Поможем с бережливым производством и программами обучения.</p>
            </div>
