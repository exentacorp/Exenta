...
const serviceGroups = [
  ...
  },
  {
    ...
    href: "/services/learning/culture-leadership",
    services: [
...
const approach = [
  { icon: BookOpen, title: "Обучение", description: "Программы и развитие компетенций" },
  { icon: Users, title: "Развитие", description: "Корпоративная культура и лидерство" },
  { icon: Sparkles, title: "Трансформация", description: "Бережливое производство и практики" },
];
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Обучение и развитие</span>
          </nav>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                От внедрения бережливого производства до готовых образовательных программ и трансформации корпоративной культуры. Обеспечиваем трансформацию бизнеса за счёт развития компетенций.
              </p>
            </div>
            <div className="hidden lg:flex justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-16 bg-[#02818a]/30 rounded-full flex items-center justify-center">
                  <GraduationCap className="w-20 h-20 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-kept">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-gray-500 max-w-2xl mb-12">
              Трансформация бизнеса через развитие компетенций и корпоративное обучение.
            </p>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужны программы обучения?</h2>
              <p className="text-white/70 max-w-xl">Подберём или разработаем программы под ваши задачи.</p>
            </div>
