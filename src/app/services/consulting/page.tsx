...
// Подразделы как на exenta.ru — «Наши услуги»
const serviceGroups = [
  {
    id: "strategy",
    icon: Target,
    title: "Стратегия и корпоративное управление",
    description:
      "Разработка стратегий развития, корпоративное управление, диагностика и дорожные карты трансформации.",
    href: "/services/consulting/strategy",
    services: [
      "Стратегия развития компании",
      "Корпоративное управление",
      "Диагностика и бенчмаркинг",
  ...
  },
  {
    ...
    description:
      "Управление портфелями проектов, трансформационными программами и сложными инициативами.",
  ...
  },
  {
    ...
    description:
      "Обоснование инвестиций, финансовое моделирование, бизнес-планы и сопровождение сделок.",
    href: "/services/consulting/investment",
    services: [
  ...
  },
  {
    ...
    icon: Shield,
    title: "Господдержка и сопровождение",
    description:
      "Подготовка заявок на меры господдержки, сопровождение проектов и привлечение льготного финансирования.",
    href: "/services/consulting/government-support",
    services: [
      "Заявки на господдержку",
      "Льготное финансирование",
      "Сопровождение проектов",
      "Реализация мер поддержки",
    ],
  },
];

const approach = [
  { icon: Target, title: "Стратегия", description: "От диагностики до дорожной карты и внедрения" },
  { icon: BarChart3, title: "Управление", description: "Проекты, портфели и трансформационные программы" },
  { icon: FileCheck, title: "Реализация", description: "Сопровождение от идеи до измеримого результата" },
];
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Консалтинг</span>
          </nav>
          <motion.div
          ...
          >
            <div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Всё об управлении проектами, инвестициями, бизнесом и господдержкой — от стратегии до реализации. Помогаем принимать обоснованные решения и достигать измеримых результатов.
              </p>
            </div>
            <div className="hidden lg:flex justify-center">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute inset-16 bg-[#02818a]/30 rounded-full flex items-center justify-center">
                  <Briefcase className="w-20 h-20 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-kept">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-gray-500 max-w-2xl mb-12">
              Комплексные решения для роста, эффективности и трансформации бизнеса.
            </p>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужна консультация?</h2>
              <p className="text-white/70 max-w-xl">Обсудим ваши задачи и подготовим предложение.</p>
            </div>
