...
const services = [
  { title: "Управление репутацией", description: "Мониторинг репутации, стратегия и мероприятия по укреплению имиджа." },
  { title: "Медиа-сопровождение", description: "Работа со СМИ, пресс-релизы и медиа-события." },
  { title: "Кризисные коммуникации", description: "Подготовка и сопровождение коммуникаций в кризисных ситуациях." },
  { title: "Работа с ключевыми СМИ", description: "Построение отношений с медиа и ключевыми изданиями." },
];

export default function CommunicationsReputationPage() {
  return (
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Репутация и PR</span>
          </nav>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#02818a]/10 text-[#02818a] text-sm font-medium mb-6">
                <Shield className="w-4 h-4" /> Направление
              </div>
              <h1 className="text-4xl lg:text-5xl font-bold text-[#02818a] mb-6">Репутация и PR</h1>
              ...
              <Link href="/services/communications/brand-identity" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Позиционирование и бренд</p>
                  </div>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужна поддержка по репутации или PR?</h2>
              <p className="text-white/70 max-w-xl">Поможем с медиа-сопровождением и кризисными коммуникациями.</p>
            </div>
