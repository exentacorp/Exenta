...
import { Calculator, ArrowRight, ChevronRight, CheckCircle } from "lucide-react";

const services = [
  { title: "Экспертиза смет", description: "Проверка сметной документации на соответствие нормативам и обоснованность затрат." },
  { title: "Оптимизация капитальных затрат", description: "Снижение КЗ за счёт альтернативных решений и оптимизации проектных решений." },
  { title: "Сравнительный анализ", description: "Сопоставление смет с аналогами и рыночными ценами на материалы и работы." },
  { title: "Нормативная база", description: "Контроль применения сметных нормативов и актуальной базы цен." },
];

export default function EngineeringCostExpertisePage() {
  return (
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Экспертиза смет и капитальных затрат</span>
          </nav>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-[#02818a] mb-6">
                Экспертиза смет и капитальных затрат
              </h1>
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative w-72 h-72">
                ...
                <div className="absolute inset-6 bg-[#02818a]/20 rounded-full flex items-center justify-center">
                  <Calculator className="w-24 h-24 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <Link href="/services/engineering/pre-project" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Обоснование инвестиций до проектирования</p>
                  </div>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужна экспертиза смет?</h2>
              <p className="text-white/70 max-w-xl">Проверим сметную документацию и поможем оптимизировать затраты.</p>
            </div>
