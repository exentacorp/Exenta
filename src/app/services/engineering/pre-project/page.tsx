...
import { FileSearch, ArrowRight, ChevronRight, CheckCircle } from "lucide-react";

const services = [
  { title: "Предпроектный анализ", description: "Оценка целесообразности, вариантов размещения и технологических решений до начала проектирования." },
  { title: "Технико-экономическое обоснование", description: "ТЭО строительства с расчётом инвестиций, сроков окупаемости и рисков." },
  { title: "Варианты реализации", description: "Сравнение сценариев: новое строительство, реконструкция, модернизация." },
  { title: "Оценка рисков", description: "Выявление технических, правовых и финансовых рисков проекта." },
];

export default function EngineeringPreProjectPage() {
  return (
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Предпроектный анализ и ТЭО</span>
          </nav>
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative w-72 h-72">
                ...
                <div className="absolute inset-6 bg-[#02818a]/20 rounded-full flex items-center justify-center">
                  <FileSearch className="w-24 h-24 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <Link href="/services/engineering/construction-management" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Контроль сроков, бюджета и подрядчиков</p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-[#02818a] group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужен предпроектный анализ?</h2>
              <p className="text-white/70 max-w-xl">Подготовим ТЭО и обоснование инвестиций.</p>
            </div>
