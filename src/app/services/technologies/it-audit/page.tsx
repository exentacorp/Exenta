...
const services = [
  { title: "Аудит ИТ-инфраструктуры и процессов", description: "Оценка текущего состояния систем, архитектуры и процессов управления ИТ." },
  { title: "Due Diligence в сделках M&A", description: "ИТ-аспекты при слияниях и поглощениях: риски, синергии, интеграция." },
  { title: "Оценка рисков и возможностей", description: "Выявление технологических и операционных рисков, рекомендации по снижению." },
  { title: "Рекомендации по оптимизации", description: "Практические предложения по улучшению ИТ-функции и затрат." },
  { title: "Соответствие требованиям", description: "Проверка соответствия регуляторным и отраслевым требованиям." },
];
    ...
    <main className="min-h-screen bg-white flex flex-col">
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">ИТ-аудит и Due Diligence</span>
          </nav>
          <motion.div
          ...
          >
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-[#02818a] mb-6">
                ИТ-аудит и Due Diligence
              </h1>
              <p className="text-lg text-gray-600 leading-relaxed">
                Независимая оценка ИТ-инфраструктуры, рисков и возможностей. Due Diligence при сделках M&A и инвестиционных решениях для обоснованных решений.
              </p>
            </div>
            <div className="hidden lg:flex justify-center">
              <div className="relative w-72 h-72">
                ...
                <div className="absolute inset-6 bg-[#02818a]/20 rounded-full flex items-center justify-center">
                  <Search className="w-24 h-24 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <Link href="/services/technologies/development" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Корпоративные системы и интеграция</p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-[#02818a] group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          ...
          >
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужен ИТ-аудит или Due Diligence?</h2>
              <p className="text-white/70 max-w-xl">Проведём оценку и подготовим рекомендации.</p>
            </div>
