...
const services = [
  { title: "Облачная инфраструктура и миграция", description: "Проектирование облачной архитектуры и перенос нагрузок в облако." },
  { title: "Гибридные и мультиоблачные решения", description: "Комбинация облака и on-premise, работа с несколькими провайдерами." },
  { title: "Управление инфраструктурой", description: "DevOps, мониторинг, отказоустойчивость и оптимизация затрат." },
  { title: "Безопасность и отказоустойчивость", description: "Защита данных, резервное копирование и планы восстановления." },
  { title: "SaaS и облачные сервисы", description: "Подбор и внедрение облачных приложений под задачи бизнеса." },
];
    ...
    <main className="min-h-screen bg-white flex flex-col">
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Облачные решения и инфраструктура</span>
          </nav>
          <motion.div
          ...
          >
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Облачная инфраструктура, миграция в облако, гибридные и мультиоблачные решения. Управление ИТ-инфраструктурой, безопасность и отказоустойчивость.
              </p>
            </div>
            <div className="hidden lg:flex justify-center">
              <div className="relative w-72 h-72">
                ...
                <div className="absolute inset-6 bg-[#02818a]/20 rounded-full flex items-center justify-center">
                  <Cloud className="w-24 h-24 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <Link href="/services/technologies/development" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Интеграция и корпоративные системы</p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-[#02818a] group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          ...
          >
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужны облачные решения или миграция?</h2>
              <p className="text-white/70 max-w-xl">Поможем с архитектурой, миграцией и управлением инфраструктурой.</p>
            </div>
