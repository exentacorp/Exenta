...
const services = [
  { title: "Промышленная автоматизация", description: "Проектирование и внедрение систем автоматизации производства." },
  { title: "IIoT и сбор данных с оборудования", description: "Подключение оборудования, датчиков и сбор данных в реальном времени." },
  { title: "Цифровые двойники", description: "Моделирование производственных процессов и активов для оптимизации." },
  { title: "Оптимизация производства", description: "Повышение OEE, снижение простоев и управление качеством." },
  { title: "Интеграция с ERP/MES", description: "Связь производственного контура с корпоративными системами." },
];
    ...
    <main className="min-h-screen bg-white flex flex-col">
      <section className="relative pt-24 pb-16 bg-gradient-to-b from-[#e8f5f3] to-white overflow-hidden">
        <div className="container-kept">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#02818a]">Промышленная автоматизация и IIoT</span>
          </nav>
          <motion.div
          ...
          >
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Промышленная автоматизация, IIoT, цифровые двойники и повышение эффективности производственных процессов. Данные с оборудования — в основу решений.
              </p>
            </div>
            <div className="hidden lg:flex justify-center">
              <div className="relative w-72 h-72">
                ...
                <div className="absolute inset-6 bg-[#02818a]/20 rounded-full flex items-center justify-center">
                  <Factory className="w-24 h-24 text-[#02818a]" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-kept">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/services/technologies/innovation" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2 group-hover:text-[#02818a] transition-colors">Корпоративные инновации и R&D</h3>
                    <p className="text-sm text-gray-500">R&D и портфель инноваций</p>
                  </div>
              ...
              <Link href="/services/technologies/development" className="p-6 bg-white border border-gray-200 hover:bg-[#f1f2f4] transition-colors group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Интеграция и автоматизация</p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-[#02818a] group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
      ...
      <section className="py-16 lg:py-20 bg-[#02818a] relative overflow-hidden">
        <div className="container-kept relative z-10">
          ...
          >
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Нужна промышленная автоматизация или IIoT?</h2>
              <p className="text-white/70 max-w-xl">Обсудим производственные задачи и варианты решений.</p>
            </div>
